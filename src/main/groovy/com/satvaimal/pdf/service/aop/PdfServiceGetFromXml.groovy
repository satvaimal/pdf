...
class PdfServiceGetFromXml {
  ...
  final static Logger log = LoggerFactory.getLogger(
      'com.satvaimal.pdf.service.aop.PdfServiceGetFromXml' )

  @Pointcut(
    value='execution(byte[] com.satvaimal.pdf.service.PdfService.getFromXml(..)) && bean(pdfService) && args(xml, templateName)',
